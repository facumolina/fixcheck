...
headers = ['id', 'project', 'main_dep', 'tests_classes', 'target_test', 'test_src_dir', 'target_class', 'input_class']
...
for bad_fix_json in all_bad_fixes_json:
    ...
    if "test_class" in bad_fix_data:
        ...
        bad_fix_input_class = ''
        bad_fix_row = [bad_fix_name, bad_fix_project, bad_fix_main_dep, bad_fix_tests_classes, bad_fix_target_test, bad_fix_test_src_dir, bad_fix_target_class, bad_fix_input_class]
