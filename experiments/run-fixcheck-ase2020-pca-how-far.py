...
subject_base_dir = os.path.join(PCA_HOW_FAR_DATASET, f'tmp/{subject_id}/{patch_base_dir}')
...
subject_output_folder = os.path.join(outputs_dir, f'ase2020/{subject_id}/{assertion_generation}')
